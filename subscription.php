...
<html lang="en">
    ...
    <body>
        ...
        <div class="main">
            <div class="container">
                <div class="row py-4">
                    <h1 class="heading-title">ग्राहाक(सब्स्क्रिप्शन)</h1>
                </div>
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="signup-tab" data-toggle="tab" href="#signup"
                                            role="tab" aria-controls="signup" aria-selected="true">साइन अप</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="fa-ul">
                                    ...
                                    <li><span class="fa-li"><i class="fas fa-times text-danger"></i></span>पत्रिकाको छापिएको संस्करण।<br></li>
                                    <br>
                                </ul>
                            </div>
                        </div>
