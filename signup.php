                ...
                <div class="row  signup py-4">
                    <div class="col-md-6 mt-4">
                        <div class="signupheader">
                            <p class="h1 mb-4 px-4 text-md-left"><strong>साइन अप</strong></p>
                        </div>
                        <?php 
                        ...
                        <?php
                            ...
                            ?>
                        <form class="px-4 text-center container" id="signup-gap" action="process/user.php"
                            method="POST">
                            <div class="row mb-4">
                                <div class="col">
                                    <!-- First name -->
                            ...
                            <div class="submitbutton text-left">
                                <a href="#"><button class="btn btncustom btn mb-4 mt-4" type="submit" value="submit">साइन
                                अप</button></a>
                            </div>
                        </form>
                        <div class="signupbutton">
                            <br>
                            <p class="text-center "><strong><span style="color: #1E695E;"> के तपाईसँग पहिले नै खाता छ?</span></strong></p>
                            <hr>
                            <a href="signin.php"><button class="btn-block btncustom btn mb-2 " type="submit" value="submit">साइन
                            इन</button></a>
                        </div>
                        <div class="forgotpassword">
                            <p class="text-center"><a href="/reset-password.php"><span style="color: #1E695E;"> पासवर्ड बिर्सनुभयो ?</span></a>
                            <p>
                            <hr>
                            </a>
                        </div>
                        <div class="signinfb">
                            <p class="text-center"><span style="color: #1E695E;"> या फेसबुकबाट साइन इन गर्नुहोस ?</span>  <br> 
                                <a>
                                <a href="#" class="pull-right"><i class="fab fa-facebook" style="font-size: 24px"></i></a>
                                </a>
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6 px-4">
                        <div class="imagebody">
                            <img src="<?php echo FRONT_ASSETS_URL ?>img/image1.png" alt="cover" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
